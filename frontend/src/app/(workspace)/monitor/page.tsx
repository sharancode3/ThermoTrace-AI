...
export default function MonitorPage() {
  ...
  return (
    <>
      <MapComponent onEventClick={setSelectedEventId} selectedEventId={selectedEventId} startTime={startTime} showFacilities={showFacilities} showObservations={showObservations} />
      <div className="absolute left-4 top-4 z-20 rounded-md border border-slate-200 bg-white p-3 shadow-sm">

...
// Automatically override old suspended URLs while allowing local dev and Render
if (!rawBackend || (!rawBackend.includes("5tao") && !rawBackend.includes("localhost") && !rawBackend.includes("127.0.0.1"))) {

...
export function TourOverlay() {
  ...
  if (!targetRect || isWaitingForElement) {
    return (
      <div className="fixed inset-0 z-[80] bg-slate-950/50 transition-opacity duration-300 animate-in fade-in pointer-events-auto flex items-center justify-center">

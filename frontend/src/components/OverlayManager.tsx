    ...
    <>
      ...
      {overlay === "chat" && (
        <>
          ...
          <div className={cn(
            "fixed inset-x-0 bottom-0 z-[60] bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 shadow-2xl rounded-t-2xl flex flex-col md:hidden transition-all duration-300 ease-in-out pb-[env(safe-area-inset-bottom)] max-h-[90dvh]",
            ...
            <div 
              ...
              className="flex md:hidden items-center justify-between px-4.5 py-2.5 bg-slate-100/90 dark:bg-slate-800/90 border-b border-slate-200 dark:border-slate-800 rounded-t-2xl cursor-pointer select-none shrink-0 active:bg-slate-200 dark:active:bg-slate-700 transition-colors"
            >
              <div className="flex items-center gap-2">
                <Flame className="w-4 h-4 text-orange-600 animate-pulse" />
                <span className="text-xs font-bold text-slate-900 dark:text-slate-100">Thermo AI Chat</span>
                {searchParams.get("eventId") && (
                  <span className="text-[10px] font-mono text-orange-700 dark:text-orange-300 bg-orange-100 dark:bg-orange-950 px-1.5 py-0.5 rounded font-bold truncate max-w-[100px]">
                    {searchParams.get("eventId")}
                  </span>
                )}
              </div>

      ...
      {overlay === "chat" && (
        <>
          ...
          {searchParams.get("eventId") ? (
            ...
            <div className="fixed inset-0 z-[60] bg-white dark:bg-slate-900 flex flex-col md:hidden w-full h-full pb-[env(safe-area-inset-bottom)] animate-in fade-in duration-200">
